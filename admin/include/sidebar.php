        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #001f54;">
            ...
            <li class="text-center">   <!-- Sidebar - Brand -->
                <a class="sidebar-brand align-items-center justify-content-center" href="index.php">
                    ...
                    <div class="">
                        <div class="sidebar-brand-text mt-2">DICT Training Management System</div>
                    </div>
                </a>
            </li>
            <!-- Divider -->
...
<!--             <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Speaker</h6>
                        <a class="collapse-item" href="">View Speakers</a>
                          <a class="collapse-item" href="">Add Speaker</a>
