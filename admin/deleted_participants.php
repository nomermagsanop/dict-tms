                            ...
                            <table class="table table-bordered nowrap" id="myTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr> 
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-sm btn-info remove-participant-btn  shadow-sm"
                                               ...
                                               data-full-name="<?php echo htmlspecialchars($full_name); ?>"><i class="fa-solid fa-rotate-left"></i>
                                            </a>
                                        </td>
                                    </tr>
                                    <?php
...
// Function for deleting event
        $('.remove-participant-btn').on('click', function(e) {
            ...
            Swal.fire({
                ...
                html: "You are about to restore:<br><br>" +
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: 'action/restore_participant.php', // Adjust the URL to your PHP script for deleting the event
                        type: 'POST',
                        data: {
