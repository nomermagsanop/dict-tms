...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO users (first_name, mid_name, last_name, ext_name, age, sex, email, contact, province, host_id, username, password, profile)
            VALUES ('$first_name', '$mid_name', '$last_name', '$ext_name', '$age', '$sex', '$email', '$contact', '$province', '$host_id ', '$username', '$hashed_password', '$file_name1')";
