...
if (isset($_POST['user_id']) && is_numeric($_POST['user_id'])) {
    ...
    $sql = "UPDATE users SET first_name='$first_name', mid_name='$mid_name', last_name='$last_name', ext_name='$ext_name', age='$age', sex='$sex', email='$email', contact='$contact', province='$province', host_id='$host_id', username='$username', role='$role'";
